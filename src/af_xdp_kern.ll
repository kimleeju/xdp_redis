...
@__const.xdp_sock_prog.____fmt = private unnamed_addr constant [11 x i8] c"aaaaaaaaa\0A\00", align 1
...
76:                                               ; preds = %69
  %77 = getelementptr inbounds [11 x i8], [11 x i8]* %3, i64 0, i64 0, !dbg !323
  call void @llvm.lifetime.start.p0i8(i64 11, i8* nonnull %77) #3, !dbg !323
  call void @llvm.dbg.declare(metadata [11 x i8]* %3, metadata !177, metadata !DIExpression()), !dbg !323
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 1 dereferenceable(11) %77, i8* nonnull align 1 dereferenceable(11) getelementptr inbounds ([11 x i8], [11 x i8]* @__const.xdp_sock_prog.____fmt, i64 0, i64 0), i64 11, i1 false), !dbg !323
  %78 = call i32 (i8*, i32, ...) inttoptr (i64 6 to i32 (i8*, i32, ...)*)(i8* nonnull %77, i32 11) #3, !dbg !323
  call void @llvm.lifetime.end.p0i8(i64 11, i8* nonnull %77) #3, !dbg !324
...
!3 = !DIFile(filename: "af_xdp_kern.c", directory: "/home/ljkim/xdp/pmem-redis/src")
!4 = !{!5, !14}
!5 = !DICompositeType(tag: DW_TAG_enumeration_type, name: "xdp_action", file: !6, line: 2845, baseType: !7, size: 32, elements: !8)
!6 = !DIFile(filename: "../headers/linux/bpf.h", directory: "/home/ljkim/xdp/pmem-redis/src")
...
!53 = distinct !DIGlobalVariable(name: "xsks_map", scope: !2, file: !3, line: 17, type: !54, isLocal: false, isDefinition: true)
!54 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "bpf_map_def", file: !55, line: 33, size: 160, elements: !56)
!55 = !DIFile(filename: "../libbpf/src//build/usr/include/bpf/bpf_helpers.h", directory: "/home/ljkim/xdp/pmem-redis/src")
!56 = !{!57, !58, !59, !60, !61}
...
!63 = distinct !DIGlobalVariable(name: "_license", scope: !2, file: !3, line: 112, type: !64, isLocal: false, isDefinition: true)
...
!70 = !DIFile(filename: "../libbpf/src//build/usr/include/bpf/bpf_helper_defs.h", directory: "/home/ljkim/xdp/pmem-redis/src")
...
!92 = !DIFile(filename: "./../common/xdp_stats_kern.h", directory: "/home/ljkim/xdp/pmem-redis/src")
!93 = !{i32 7, !"Dwarf Version", i32 4}
!94 = !{i32 2, !"Debug Info Version", i32 3}
!95 = !{i32 1, !"wchar_size", i32 4}
!96 = !{!"clang version 10.0.0-4ubuntu1 "}
!97 = distinct !DISubprogram(name: "xdp_sock_prog", scope: !3, file: !3, line: 25, type: !98, scopeLine: 26, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !108)
...
!109 = !DILocalVariable(name: "ctx", arg: 1, scope: !97, file: !3, line: 25, type: !100)
!110 = !DILocalVariable(name: "index", scope: !97, file: !3, line: 27, type: !81)
!111 = !DILocalVariable(name: "pkt_count", scope: !97, file: !3, line: 30, type: !112)
!112 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !84, size: 64)
!113 = !DILocalVariable(name: "eth_type", scope: !97, file: !3, line: 43, type: !81)
!114 = !DILocalVariable(name: "ip_type", scope: !97, file: !3, line: 43, type: !81)
!115 = !DILocalVariable(name: "eth", scope: !97, file: !3, line: 44, type: !116)
...
!129 = !DILocalVariable(name: "iphdr", scope: !97, file: !3, line: 45, type: !130)
...
!148 = !DILocalVariable(name: "tcphdr", scope: !97, file: !3, line: 46, type: !149)
...
!170 = !DILocalVariable(name: "data_end", scope: !97, file: !3, line: 47, type: !46)
!171 = !DILocalVariable(name: "data", scope: !97, file: !3, line: 48, type: !46)
!172 = !DILocalVariable(name: "nh", scope: !97, file: !3, line: 49, type: !173)
!173 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "hdr_cursor", file: !174, line: 33, size: 64, elements: !175)
!174 = !DIFile(filename: "./../common/parsing_helpers.h", directory: "/home/ljkim/xdp/pmem-redis/src")
!175 = !{!176}
!176 = !DIDerivedType(tag: DW_TAG_member, name: "pos", scope: !173, file: !174, line: 34, baseType: !46, size: 64)
!177 = !DILocalVariable(name: "____fmt", scope: !178, file: !3, line: 70, type: !183)
!178 = distinct !DILexicalBlock(scope: !179, file: !3, line: 70, column: 17)
!179 = distinct !DILexicalBlock(scope: !180, file: !3, line: 69, column: 24)
!180 = distinct !DILexicalBlock(scope: !181, file: !3, line: 69, column: 12)
!181 = distinct !DILexicalBlock(scope: !182, file: !3, line: 63, column: 33)
!182 = distinct !DILexicalBlock(scope: !97, file: !3, line: 63, column: 9)
!183 = !DICompositeType(tag: DW_TAG_array_type, baseType: !65, size: 88, elements: !184)
!184 = !{!185}
!185 = !DISubrange(count: 11)
!186 = !DILocation(line: 0, scope: !97)
!187 = !DILocation(line: 27, column: 5, scope: !97)
!188 = !DILocation(line: 27, column: 22, scope: !97)
!189 = !{!190, !191, i64 16}
!190 = !{!"xdp_md", !191, i64 0, !191, i64 4, !191, i64 8, !191, i64 12, !191, i64 16}
!191 = !{!"int", !192, i64 0}
!192 = !{!"omnipotent char", !193, i64 0}
!193 = !{!"Simple C/C++ TBAA"}
!194 = !DILocation(line: 27, column: 9, scope: !97)
!195 = !{!191, !191, i64 0}
!196 = !DILocation(line: 32, column: 17, scope: !97)
!197 = !DILocation(line: 47, column: 41, scope: !97)
!198 = !{!190, !191, i64 4}
!199 = !DILocation(line: 47, column: 30, scope: !97)
!200 = !DILocation(line: 47, column: 22, scope: !97)
!201 = !DILocation(line: 48, column: 37, scope: !97)
!202 = !{!190, !191, i64 0}
!203 = !DILocation(line: 48, column: 26, scope: !97)
!204 = !DILocation(line: 48, column: 18, scope: !97)
...
!262 = distinct !DILexicalBlock(scope: !97, file: !3, line: 55, column: 9)
...
!275 = distinct !DILocation(line: 56, column: 19, scope: !276)
!276 = distinct !DILexicalBlock(scope: !262, file: !3, line: 55, column: 42)
!277 = !DILocation(line: 158, column: 14, scope: !264, inlinedAt: !275)
!278 = !DILocation(line: 52, column: 9, scope: !97)
...
!293 = !DILocation(line: 63, column: 17, scope: !182)
...
!306 = distinct !DILocation(line: 65, column: 13, scope: !307)
!307 = distinct !DILexicalBlock(scope: !181, file: !3, line: 65, column: 13)
!308 = !DILocation(line: 254, column: 12, scope: !295, inlinedAt: !306)
!309 = !DILocation(line: 63, column: 9, scope: !97)
...
!320 = !DILocation(line: 69, column: 20, scope: !180)
!321 = !DILocation(line: 69, column: 12, scope: !180)
!322 = !DILocation(line: 263, column: 6, scope: !296, inlinedAt: !306)
!323 = !DILocation(line: 70, column: 17, scope: !178)
!324 = !DILocation(line: 70, column: 17, scope: !179)
!325 = !DILocation(line: 82, column: 48, scope: !179)
!326 = !DILocation(line: 82, column: 20, scope: !179)
!327 = !DILocation(line: 82, column: 13, scope: !179)
!328 = !DILocation(line: 95, column: 1, scope: !97)
